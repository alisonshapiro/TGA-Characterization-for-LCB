...
% all 12 parameters, then paste findings into Herbaceous_model.m and run
...
plot(Temp, G4, 'Color', 'c', 'LineWidth', 2)
plot(Temp, fit, 'LineStyle', '--', 'Color', 'k', 'LineWidth', 2)
xlabel('Temperature (°C)')
ylabel('Derivative (wt. %/°C)')

legend('Experimental','Hemicellulose', 'Cellulose 1', 'Cellulose 2','Lignin','Fit')
legend('boxoff')
axis([150,600,0,2.5])
